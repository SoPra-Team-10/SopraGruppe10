...
\begin{document}
    ...
    \input{MainClientStruktur.tex}
	\section{Grafische Gestaltung und Nutzungskonzept}
    \input{MainClientDesign.tex}	
    
    
    \includepdf[pages=-, scale=0.8, pagecommand={\section{Dialogstruktur}\subsection{Client}\subsubsection{Hauptdiagramm}}]{images/Client_Hauptmenue.pdf}
    \input{Client_Hauptmenue}
    \subsection{Server}
