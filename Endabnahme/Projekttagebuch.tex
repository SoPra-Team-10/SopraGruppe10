...
\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{./images/Verantwortlicher_Chart.PNG}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{./images/Typ_Chart.PNG}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=\textwidth]{./images/Anwesend_Chart.PNG}
\end{figure}