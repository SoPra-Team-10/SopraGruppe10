...
\begin{document}
    ...
    \fakt	{Nutzer}
			...
			{Ein Mensch, der entweder als Spieler aktiv an einem Spiel teilnimmt, als Gast passiv einem Spiel zusieht oder den Quidditchteam-Editor benutzt, um ein Team zu erstellen oder anzupassen.}
	...
	\fakt	{Systemadministrator}
			{Anwendungsnutzer mit erweiterten Rechten, um Server zu verwalten.}
	...
	\fakt	{Client}
			{Stellt die grafische Oberfläche zur Verfügung, über die ein Nutzer das Spiel \glqq{}Fantastic Feasts\grqq{} spielen kann.}
	...
	\fakt	{KI-Client}
			{Anwendung, die die KI steuert.}
			{Der KI-Client ist die Anwendung, die eine KI steuert. Der Nutzer kann von Außen keinen Einfluss auf die Züge und Entscheidungen des KI-Clients nehmen.}
	...
	\fakt	{Quidditchteam-Editor}
			...
			{Mit dieser Anwendung kann ein Nutzer sein, für eine Partie gewünschtes Quiddichteam, im Rahmen bestimmter Grenzen konfigurieren.}
