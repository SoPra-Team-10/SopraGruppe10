...
\begin{document}
	...
	%TODO Wahrscheinlichkeiten müssen festgelegt werden!
	...
	\fanf	{Jäger [Spielertyp]}
			{Die Jäger sind die Spieler auf dem Spielfeld, welche versuchen die Punkte für das Team mithilfe des Quaffels zu erzielen. }
			{Diese Anforderung geht aus den im Lastenheft zu Verfügung gestellten Spielregeln für das Spiel \textit{Fantastic Feasts} hervor.}
			{<Abhängigkeiten>}
			{<Prio>}
			{<Akteure>}
