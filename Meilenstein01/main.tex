...
\begin{document}
    ...
    \fakt	{Nutzer}
			...
			{Ein Mensch, welcher entweder als Spieler aktiv an einem Spiel teilnimmt oder als Gast passiv einem Spiel zusieht oder den Quidditchteam-Editor benutzt um ein Team zu erstellen oder an zu passen.}
	...
	\fanf	{Torschuss}
			...
			{Diese Anforderung ist wichtug, da die Teams Punkte erzielen sollen und dazu müssen die einen Torschuss absolvieren.}
	...
	\qanf 	{Effizienz}
			...
			{Eine ressourcenschonende Anwendung ist auch auf älteren Zielsystemen poblemlos nutzbar.}
			{-}
			{-}
			{Nutzer, Entwickler}
