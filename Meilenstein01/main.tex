...
\begin{document}
    ...
    \includepdf[scale = 0.8, pagecommand={\section{Domänenmodell}\subsection{Gesamt}}]{domaenenmodell.pdf}
    ...
    \input{Akteure.tex} 
    \input{FunktionaleAnforderungen.tex} 
    \input{NichtFunktionaleAnforderungen.tex} 
\end{document}
