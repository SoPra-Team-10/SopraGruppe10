...
\input{../Meilenstein02/FA_Gruppierung.tex}
...
\includepdf[pages=-, scale=0.8, pagecommand={\subsubsection{State-Machine Rundenablauf}}]{../Meilenstein02/images/SM_Rundenablauf.pdf}
