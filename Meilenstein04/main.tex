...
\graphicspath{{../Meilenstein01/},{../Meilenstein02}, {../Meilenstein03}}
...
\begin{document}
    ...
    %TODO
    \includepdf[scale = 0.8, pagecommand={\section{Datenmodell}\subsection{Gesamt}}]{domaenenmodell.pdf}
    \includepdf[scale = 0.8, pagecommand={\subsection{Fan}}]{fan.pdf}
    \includepdf[scale = 0.8, pagecommand={\subsection{Foul}}]{foul.pdf}
    \includepdf[scale = 0.8, pagecommand={\subsection{Besen}}]{besen.pdf}
    \includepdf[scale = 0.8, pagecommand={\subsection{Wurf}}]{wurf.pdf}
    \includepdf[scale = 0.8, pagecommand={\subsection{Zelle}}]{zelle.pdf}
    \includepdf[scale = 0.8, pagecommand={\subsection{Ball}}]{ball.pdf}
    \includepdf[scale = 0.8, pagecommand={\subsection{Interaktion der Spieler mit den Bällen}}]{ballSpieler.pdf}
    \section{Funktionen}
    %TODO
