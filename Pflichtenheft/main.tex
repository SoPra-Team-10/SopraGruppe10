...
\begin{document}
    ...
    \part{Überblick}
    \input{../Meilenstein01/kontextanalyse.tex}

    \part{Anforderungsanalyse} 
    \section{Fachwissen}
    \input{../Meilenstein01/Aufgabe_2_Fachwissen.tex}
    \section{Anwendungskontext}
    \input{../Meilenstein01/Akteure.tex}
	\input{../Meilenstein04/AnwendungsfaelleUndAblaeufe.tex}
    \section{Anforderungsdefinition} \label{FAs}
    \input{../Meilenstein01/FunktionaleAnforderungen.tex} 

    \part{Softwarespezifikation}
    \section{Schnittstellenarten, Dialoge und Dialogstruktur}
    \subsection{Client}
    \input{../Meilenstein03/MainClientStruktur.tex}
    \subsection{Server}
    \input{../Meilenstein03/Server.tex}
    \subsection{Team- und Partiekonfigurator}
    \input{../Meilenstein03/DialogStrukturKonfigurator.tex}
    \subsection{KI-Client}
    \input{../Meilenstein03/KI-Client.tex}
    
	\section{Grafische Gestaltung und Nutzungskonzept}
    \subsection{Client}
    \input{../Meilenstein03/MainClientDesign.tex}	
    \subsection{Server}
    \input{../Meilenstein03/GraphischeGestaltungServer}	
    \subsection{Team- und Partiekonfiguration}
    \input{../Meilenstein03/GraphischeGestaltungKonfigurator}	

    \input{../Meilenstein04/Datenmodell}
    \section{Funktionen}
    \input{../Meilenstein04/funktionen}

    \part{Randbedingungen}
    \section{Qualität}
    \input{../Meilenstein01/NichtFunktionaleAnforderungen.tex}
    \section{Betriebskonzept}
    \input{../Meilenstein04/Betriebskonzept}
    \section{Entwicklungsvorgaben}
    \input{../Meilenstein04/Entwicklungsvorgaben}
    \section{Abnahmekriterien}
    \input{../Meilenstein04/Abnahmekriterien}
\end{document}
