...
\begin{document}
    ...
    \includepdf[pages=-, scale=0.8, pagecommand={\section{Abläufe im System}\subsection{State-Machine Client}}]{images/Client_SM.pdf}
    \includepdf[pages=-, scale=0.8, pagecommand={\subsection{State-Machine Server}}]{images/SM_Server.pdf}
\end{document}
