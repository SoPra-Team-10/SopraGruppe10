...
\begin{document}
    ...
    \includepdf[pages=-]{images/AFD_Client.pdf}
    \includepdf[pages=-]{images/AFD_Editor.pdf}
    \includepdf[pages=-]{images/AFD_Party.pdf}
    \includepdf[pages=-]{images/Client_SM.pdf}
    \section{Abläufe im System}
    \subsection{Diagramm 1}
    \subsection{Diagramm 2}
    %TODO
\end{document}
