...
\begin{document}
    ...
    \includepdf[pages=-, scale=0.8, pagecommand={\section{Abläufe im System}\subsection{State-Machine Clientanwendung}}]{images/Client_SM.pdf}
    \includepdf[pages=-, scale=0.8, pagecommand={\subsection{State-Machine Partie Server}}]{images/SM_Server.pdf}
    \includepdf[pages=-, scale=0.9, pagecommand={\subsection{State-Machine Partie Client}}]{images/SM_ClientAnmelden.pdf}
    \includepdf[pages=-, scale=0.8, pagecommand={\subsection{Sequenzdiagramm Spielaufstellung}}]{images/SD_Spielaufstellung.pdf}
    \includepdf[pages=-, scale=0.8, pagecommand={\subsection{Sequenzdiagramm Spielvorbereitung}}]{images/SD_Spielvorbereitung.pdf}
